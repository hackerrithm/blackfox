...
import (
	...
	userCfg "github.com/hackerrithm/blackfox/services/backend/user/configs"
	"github.com/hackerrithm/blackfox/services/backend/user/pkg/adapters"
	reg "github.com/hackerrithm/blackfox/services/backend/user/pkg/adapters/registry"
	"github.com/hackerrithm/blackfox/services/backend/user/pkg/engine"
	"github.com/hackerrithm/blackfox/services/backend/user/pkg/providers/authentication"
	"github.com/hackerrithm/blackfox/services/backend/user/pkg/providers/mongodb"
)
...
func main() {
	...
	eUser := engine.NewEngine(strg, sec)
	userObject := &user{eUser.NewUser()}
